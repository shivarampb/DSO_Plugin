...
CRTM3004Plugin::CRTM3004Plugin()
    : m_limits{"RTM3004", "Rohde & Schwarz",
               "RTM3000", "RTM3004",
               4,         16,
               1.0e9,     5.0e9,
               40000000u, 1.0e-3,
               ...
               2.5e7,     6.0,
               "0x0AAD",  "0x01D6"},
      m_pLimits(&m_limits), m_strModel(QStringLiteral("RTM3004"))
{
}
...
ScopeError CRTM3004Plugin::setDouble(U32BIT s, const char* scpi, FDOUBLE v, FDOUBLE lo, FDOUBLE hi,
                                     const char* what)
{
    if (v < lo || v > hi)
    {
...
ScopeError CRTM3004Plugin::reset(U32BIT s)
{
    return sendChecked(s, QByteArrayLiteral("*RST"));
}
ScopeError CRTM3004Plugin::clearStatus(U32BIT s)
{
...
ScopeError CRTM3004Plugin::getParameterRange(U32BIT s, U32BIT c, Enum_Scope_ParamId p,
...
ScopeError CRTM3004Plugin::autoscale(U32BIT s)
{
...
ScopeError CRTM3004Plugin::forceTrigger(U32BIT s)
{
...
ScopeError CRTM3004Plugin::clearErrorStatus(U32BIT s, U32BIT)
{
    return writeLine(s, QByteArrayLiteral("*CLS"));
}
...
ScopeError CRTM3004Plugin::writeScpi(U32BIT s, const QString& v)
{
...
ScopeError CRTM3004Plugin::readMeasurement(U32BIT s, U32BIT c, Enum_Scope_MeasType t,
...
ScopeError CRTM3004Plugin::clearMeasurements(U32BIT s)
{
...
ScopeError CRTM3004Plugin::getMeasurementStatistics(U32BIT s, U32BIT c, Enum_Scope_MeasType t,
                                                    S_Scope_MeasurementResult& o)
{
...
ScopeError CRTM3004Plugin::enableMath(U32BIT s, bool v)
{
...
ScopeError CRTM3004Plugin::setFftSpan(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray("CALCulate:MATH1:FFT:SPAN ") + fmtD(v));
}
ScopeError CRTM3004Plugin::setFftCenter(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray("CALCulate:MATH1:FFT:CFRequency ") + fmtD(v));
}
ScopeError CRTM3004Plugin::setMathScale(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray("CALCulate:MATH1:SCALe ") + fmtD(v));
}
ScopeError CRTM3004Plugin::setMathPosition(U32BIT s, FDOUBLE v)
{
...
ScopeError CRTM3004Plugin::setGraticule(U32BIT s, const QString& v)
{
    return sendChecked(s, QByteArray("DISPlay:DIAGram:GRID:STYLe ") + v.toLatin1());
}
ScopeError CRTM3004Plugin::setIntensity(U32BIT s, FDOUBLE v)
{
...
ScopeError CRTM3004Plugin::setVectors(U32BIT s, bool v)
{
    return sendChecked(s, QByteArray("DISPlay:DIAGram:STYLe ") + (v ? "VECTors" : "DOTS"));
}

ScopeError CRTM3004Plugin::saveSetup(U32BIT s, U32BIT loc)
{
    return sendChecked(s, QByteArray("*SAV ") + QByteArray::number(loc));
}
ScopeError CRTM3004Plugin::recallSetup(U32BIT s, U32BIT loc)
{
...
ScopeError CRTM3004Plugin::setKeyLock(U32BIT s, bool v)
{
...
ScopeError CRTM3004Plugin::setBeeper(U32BIT s, bool v)
{
