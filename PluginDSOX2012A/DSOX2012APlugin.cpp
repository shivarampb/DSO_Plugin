...
CDSOX2012APlugin::CDSOX2012APlugin() : m_pLimits(nullptr), m_strModel(QStringLiteral(KS_MODEL_NAME))
{
...
ScopeError CDSOX2012APlugin::reset(U32BIT s)
{
    return sendChecked(s, QByteArrayLiteral("*RST"));
}
ScopeError CDSOX2012APlugin::clearStatus(U32BIT s)
{
...
ScopeError CDSOX2012APlugin::waitOperationComplete(U32BIT s)
{
    QByteArray r;
...
ScopeError CDSOX2012APlugin::getParameterRange(U32BIT s, U32BIT c, Enum_Scope_ParamId p,
...
ScopeError CDSOX2012APlugin::autoscale(U32BIT s)
{
    return sendChecked(s, QByteArrayLiteral(":AUToscale"));
}
ScopeError CDSOX2012APlugin::run(U32BIT s)
{
...
ScopeError CDSOX2012APlugin::stop(U32BIT s)
{
...
ScopeError CDSOX2012APlugin::single(U32BIT s)
{
...
ScopeError CDSOX2012APlugin::forceTrigger(U32BIT s)
{
...
ScopeError CDSOX2012APlugin::getTimebaseScale(U32BIT s, FDOUBLE& o)
{
    return queryDouble(s, QByteArrayLiteral(":TIMebase:SCALe?"), o);
}
ScopeError CDSOX2012APlugin::setTimebasePosition(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":TIMebase:POSition ") + fmtD(v));
}
ScopeError CDSOX2012APlugin::getTimebasePosition(U32BIT s, FDOUBLE& o)
{
...
ScopeError CDSOX2012APlugin::getTriggerHoldoff(U32BIT s, FDOUBLE& o)
{
...
ScopeError CDSOX2012APlugin::clearErrorStatus(U32BIT s, U32BIT)
{
    return writeLine(s, QByteArrayLiteral("*CLS"));
}
...
ScopeError CDSOX2012APlugin::writeScpi(U32BIT s, const QString& v)
{
...
ScopeError CDSOX2012APlugin::readMeasurement(U32BIT s, U32BIT c, Enum_Scope_MeasType t,
...
ScopeError CDSOX2012APlugin::clearMeasurements(U32BIT s)
{
...
ScopeError CDSOX2012APlugin::getMeasurementStatistics(U32BIT s, U32BIT c, Enum_Scope_MeasType t,
                                                      S_Scope_MeasurementResult& o)
{
...
ScopeError CDSOX2012APlugin::enableMath(U32BIT s, bool v)
{
...
ScopeError CDSOX2012APlugin::setFftSpan(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":FUNCtion:FFT:SPAN ") + fmtD(v));
}
ScopeError CDSOX2012APlugin::setFftCenter(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":FUNCtion:FFT:CENTer ") + fmtD(v));
}
ScopeError CDSOX2012APlugin::setMathScale(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":FUNCtion:SCALe ") + fmtD(v));
}
ScopeError CDSOX2012APlugin::setMathPosition(U32BIT s, FDOUBLE v)
{
...
ScopeError CDSOX2012APlugin::setGraticule(U32BIT s, const QString& v)
{
    return sendChecked(s, QByteArray(":DISPlay:GRATicule ") + v.toLatin1());
}
ScopeError CDSOX2012APlugin::setIntensity(U32BIT s, FDOUBLE v)
{
...
ScopeError CDSOX2012APlugin::setVectors(U32BIT s, bool v)
{
    return sendChecked(s, QByteArray(":DISPlay:VECTors ") + (v ? "ON" : "OFF"));
}

ScopeError CDSOX2012APlugin::saveSetup(U32BIT s, U32BIT loc)
{
    return sendChecked(s, QByteArray("*SAV ") + QByteArray::number(loc));
}
ScopeError CDSOX2012APlugin::recallSetup(U32BIT s, U32BIT loc)
{
...
ScopeError CDSOX2012APlugin::setKeyLock(U32BIT s, bool v)
{
...
ScopeError CDSOX2012APlugin::setBeeper(U32BIT s, bool v)
{
    (void)v;
    return writeLine(s, QByteArrayLiteral("*CLS"));
}
