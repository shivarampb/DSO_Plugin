 ...
 *--------------------------------------------------------------------------*/
enum class Enum_Scope_Coupling       { m_enumDC, m_enumAC, m_enumGND };
enum class Enum_Scope_BandwidthLimit { m_enumFull, m_enum20MHz, m_enum200MHz, m_enum250MHz };
enum class Enum_Scope_InputImpedance { m_enum1M, m_enum50 };

enum class Enum_Scope_TriggerMode    { m_enumAuto, m_enumNormal, m_enumSingle };
enum class Enum_Scope_TriggerType
{
    m_enumEdge, m_enumPulse, m_enumWidth, m_enumVideo,
    m_enumPattern, m_enumRunt, m_enumSlope, m_enumSetupHold, m_enumSerial
};
enum class Enum_Scope_TriggerSlope   { m_enumRising, m_enumFalling, m_enumEither };
enum class Enum_Scope_TriggerSource
{
    m_enumCh1, m_enumCh2, m_enumCh3, m_enumCh4,
    m_enumExt, m_enumLine, m_enumDigital
};
enum class Enum_Scope_TriggerState
{
    m_enumArmed, m_enumReady, m_enumTriggered, m_enumAuto, m_enumStopped, m_enumUnknown
};

enum class Enum_Scope_AcqMode
{
    m_enumSample, m_enumPeakDetect, m_enumAverage, m_enumHiRes, m_enumEnvelope
};
enum class Enum_Scope_AcqState       { m_enumRunning, m_enumStopped, m_enumComplete };

enum class Enum_Scope_WaveformFormat { m_enumByte, m_enumWord, m_enumAscii };
enum class Enum_Scope_WaveformSource { m_enumChannel, m_enumMath, m_enumRef, m_enumDigital };

enum class Enum_Scope_MeasType
{
    m_enumVpp, m_enumVmax, m_enumVmin, m_enumVrms, m_enumVavg,
    m_enumFrequency, m_enumPeriod, m_enumRiseTime, m_enumFallTime,
    m_enumPosWidth, m_enumNegWidth, m_enumDutyCycle, m_enumOvershoot,
    m_enumPhase, m_enumDelay, m_enumUnknown
};

enum class Enum_Scope_MathOp    { m_enumAdd, m_enumSub, m_enumMult, m_enumDiv, m_enumFFT };
enum class Enum_Scope_FftWindow { m_enumRect, m_enumHann, m_enumHamming, m_enumBlackman, m_enumFlattop };
enum class Enum_Scope_CursorType{ m_enumOff, m_enumHorizontal, m_enumVertical, m_enumTrack };
enum class Enum_Scope_TimebaseMode { m_enumMain, m_enumZoom, m_enumRoll, m_enumXY };
enum class Enum_Scope_RemoteState  { m_enumLocal, m_enumRemote, m_enumRWLock };
enum class Enum_Scope_ImageFormat  { m_enumPng, m_enumBmp };
...
struct S_Scope_ConnectionConfig
{
    ...
    S_Scope_ConnectionConfig()
        : m_enumProtocol(Enum_Scope_CommunicationProtocol::USB)
...
struct S_Scope_ChannelCapabilities
{
    ...
    S_Scope_ChannelCapabilities()
        ...
        , m_dBandwidthHz(0.0)
        , m_dMaxVerticalScale(0.0)
        , m_dMinVerticalScale(0.0)
        , m_bHas50Ohm(false)
...
struct S_Scope_Capabilities
{
    ...
    S_Scope_Capabilities()
        ...
        , m_u32NumberOfDigital(0)
        , m_dBandwidthHz(0.0)
        , m_dMaxSampleRate(0.0)
        , m_u32MaxMemoryDepth(0)
        , m_dMinTimebaseScale(0.0)
        , m_dMaxTimebaseScale(0.0)
        , m_bHasDigital(false)
        , m_bHasAWG(false)
        , m_bHasFFT(false)
        , m_bHasSerialDecode(false)
        , m_bHasSegmented(false)
    {}
...
{
    m_enumVerticalScale, m_enumVerticalOffset, m_enumVerticalPosition,
    m_enumTimebaseScale, m_enumTimebasePosition,
    m_enumTriggerLevel, m_enumTriggerHoldoff,
    m_enumProbeAttenuation, m_enumSampleRate, m_enumMemoryDepth,
    m_enumAverageCount, m_enumWaveformPoints,
    m_enumAwgFrequency, m_enumAwgAmplitude, m_enumMeasureThreshold
};
...
struct S_Scope_WaveformPreamble
{
    ...
    S_Scope_WaveformPreamble()
        : m_iFormat(0), m_iType(0), m_u32Points(0), m_u32Count(1)
        , m_dXIncrement(0.0), m_dXOrigin(0.0), m_dXReference(0.0)
        , m_dYIncrement(0.0), m_dYOrigin(0.0), m_dYReference(0.0)
    {}
};
...
struct S_Scope_Waveform
{
    ...
    U32BIT pointCount() const { return static_cast<U32BIT>(m_vecVolts.size()); }
};
...
struct S_Scope_MeasurementResult
{
    ...
    S_Scope_MeasurementResult()
        : m_eType(Enum_Scope_MeasType::m_enumUnknown)
        , m_dValue(0.0), m_bValid(false)
        , m_dMin(0.0), m_dMax(0.0), m_dMean(0.0), m_dStdDev(0.0)
    {}
};
