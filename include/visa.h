...
#define _VI_FUNC
    ...
    ViStatus _VI_FUNC viOpen(ViSession sesn, const ViChar* name, ViAccessMode mode, ViUInt32 timeout,
                             ViPSession vi);
    ...
    ViStatus _VI_FUNC viFindRsrc(ViSession sesn, const ViChar* expr, ViFindList* findList, ViPUInt32 retcnt,
                                 ViChar desc[]);
