...
struct SCOPECORE_EXPORT S_Scope_DeviceErrorStatus
{
    ...
    S_Scope_DeviceErrorStatus()
        : m_statusFlags(Enum_Scope_DeviceStatusFlag::NoError),
          ...
          m_EnumAcqState(Enum_Scope_AcqState::m_enumStopped), m_iStandardEventStatus(0),
          m_iQuestionableStatus(0), m_iOperationStatus(0)
    {
...
class SCOPECORE_EXPORT ScopeError
{
  public:
     ...
     * @pre    None.
     */
    Enum_Scope_ErrorCode code() const
    {
        return m_eCode;
    }
    ...
    {
        return m_eCode == Enum_Scope_ErrorCode::SUCCESS;
    }
