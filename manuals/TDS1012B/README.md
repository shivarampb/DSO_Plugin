# TDS1012B - Tektronix (TDS1000B)

Place the following PDFs in this folder (see `../README.md` for the sourcing
recipe). They are **not shipped**.

1. **TDS1000B/2000B Programmer Manual** - the SCPI reference (single source of truth).
2. **TDS1012B datasheet** - drives this model's `S_ScopeLimits` row.

Expected files (any filename is fine; these are suggestions):
- `TDS1012B_ProgrammingManual.pdf`
- `TDS1012B_Datasheet.pdf`
