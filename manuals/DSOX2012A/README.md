# DSOX2012A - Keysight (Agilent) (InfiniiVision 2000 X)

Place the following PDFs in this folder (see `../README.md` for the sourcing
recipe). They are **not shipped**.

1. **InfiniiVision 2000 X Programmer's Guide** - the SCPI reference (single source of truth).
2. **DSOX2012A datasheet** - drives this model's `S_ScopeLimits` row.

Expected files (any filename is fine; these are suggestions):
- `DSOX2012A_ProgrammingManual.pdf`
- `DSOX2012A_Datasheet.pdf`
