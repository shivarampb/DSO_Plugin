...
1. **Infiniium S-Series Programmer's Guide** - the SCPI reference (single source of truth).
2. **DSOS204A datasheet** - drives this model's `S_ScopeLimits` row.

Expected files (any filename is fine; these are suggestions):
- `DSOS204A_ProgrammingManual.pdf`
- `DSOS204A_Datasheet.pdf`
