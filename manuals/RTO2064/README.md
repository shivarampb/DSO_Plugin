# RTO2064 - Rohde & Schwarz (RTO2000)

Place the following PDFs in this folder (see `../README.md` for the sourcing
recipe). They are **not shipped**.

1. **RTO2000 User Manual (Remote Control chapters)** - the SCPI reference (single source of truth).
2. **RTO2064 datasheet** - drives this model's `S_ScopeLimits` row.

Expected files (any filename is fine; these are suggestions):
- `RTO2064_ProgrammingManual.pdf`
- `RTO2064_Datasheet.pdf`
