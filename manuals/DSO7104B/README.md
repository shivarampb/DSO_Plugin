# DSO7104B - Keysight (Agilent) (InfiniiVision 7000)

Place the following PDFs in this folder (see `../README.md` for the sourcing
recipe). They are **not shipped**.

1. **InfiniiVision 7000 Programmer's Guide** - the SCPI reference (single source of truth).
2. **DSO7104B datasheet** - drives this model's `S_ScopeLimits` row.

Expected files (any filename is fine; these are suggestions):
- `DSO7104B_ProgrammingManual.pdf`
- `DSO7104B_Datasheet.pdf`
