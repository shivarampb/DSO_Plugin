# MSO6054A - Agilent (Keysight) (6000 Series)

Place the following PDFs in this folder (see `../README.md` for the sourcing
recipe). They are **not shipped**.

1. **6000 Series Programmer's Guide** - the SCPI reference (single source of truth).
2. **MSO6054A datasheet** - drives this model's `S_ScopeLimits` row.

Expected files (any filename is fine; these are suggestions):
- `MSO6054A_ProgrammingManual.pdf`
- `MSO6054A_Datasheet.pdf`
