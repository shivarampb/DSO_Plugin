...
ScopeError CTDS1012BPlugin::setDouble(U32BIT s, const char* scpi, FDOUBLE v, FDOUBLE lo, FDOUBLE hi, const char* what)
{
    if (v < lo || v > hi)
...
ScopeError CTDS1012BPlugin::reset(U32BIT s)          { return sendChecked(s, QByteArrayLiteral("*RST")); }
ScopeError CTDS1012BPlugin::clearStatus(U32BIT s)    { return writeLine(s, QByteArrayLiteral("*CLS")); }
...
ScopeError CTDS1012BPlugin::getParameterRange(U32BIT s, U32BIT c, Enum_Scope_ParamId p, S_Scope_ParameterRange& o)
{
    if (!isConnected(s)) return ScopeError(Enum_Scope_ErrorCode::NOT_CONNECTED);
...
ScopeError CTDS1012BPlugin::autoscale(U32BIT s)    { return sendChecked(s, QByteArrayLiteral("AUTOSet EXECute")); }
...
ScopeError CTDS1012BPlugin::forceTrigger(U32BIT s) { return sendChecked(s, QByteArrayLiteral("TRIGger FORCe")); }
...
ScopeError CTDS1012BPlugin::clearErrorStatus(U32BIT s, U32BIT) { return writeLine(s, QByteArrayLiteral("*CLS")); }
...
ScopeError CTDS1012BPlugin::writeScpi(U32BIT s, const QString& v) { return writeLine(s, v.toLatin1()); }
