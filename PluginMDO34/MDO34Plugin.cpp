 ...
 *==========================================================================*/
CMDO34Plugin::CMDO34Plugin()
    : m_limits{ "MDO34", "Tektronix", "3 Series MDO", "MDO3",
                ...
                "0x0699", "0x0522" }
    , m_pLimits(&m_limits)
    , m_strModel(QStringLiteral("MDO34"))
{
}
...
S_Scope_PluginInfo CMDO34Plugin::getPluginInfo() const
{
    ...
    qstrncpy(s.m_szDescription, "Tektronix MDO34 mixed-domain oscilloscope, 1 GHz, 4 analog ch",
...
S_Scope_Capabilities CMDO34Plugin::getCapabilities() const
{
 ...
 *  Instance / transport
 *==========================================================================*/
CMDO34Plugin::S_DeviceInstance* CMDO34Plugin::dev(U32BIT s)
{
    auto it = m_devices.find(s);
    return (it == m_devices.end()) ? nullptr : &it.value();
}
bool CMDO34Plugin::validChannel(U32BIT c) const
{
    return c >= 1 && static_cast<int>(c) <= m_pLimits->m_iAnalogChannels;
}
QByteArray CMDO34Plugin::fmtD(FDOUBLE v)
{
    char sz[40];
    std::snprintf(sz, sizeof(sz), "%.6G", v);
    return QByteArray(sz);
}
const char* CMDO34Plugin::srcTok(Enum_Scope_TriggerSource e)
{
    switch (e) {
    case Enum_Scope_TriggerSource::m_enumCh1: return "CH1";
    case Enum_Scope_TriggerSource::m_enumCh2: return "CH2";
    case Enum_Scope_TriggerSource::m_enumCh3: return "CH3";
    case Enum_Scope_TriggerSource::m_enumCh4: return "CH4";
    case Enum_Scope_TriggerSource::m_enumExt: return "AUX";
    case Enum_Scope_TriggerSource::m_enumLine: return "LINE";
    default: return "CH1";
    }
}

ScopeError CMDO34Plugin::visaError(ViStatus st, const QString& ctx)
{
    if (st == VI_ERROR_TMO)
    ...
    return ScopeError(Enum_Scope_ErrorCode::COMMUNICATION_ERROR,
                      ...
                      .arg(ctx).arg(static_cast<quint32>(st), 8, 16, QLatin1Char('0')));
}

ScopeError CMDO34Plugin::writeLine(U32BIT s, const QByteArray& cmd)
{
...
ScopeError CMDO34Plugin::readLine(U32BIT s, QByteArray& resp)
{
    resp.clear();
    S_DeviceInstance* d = dev(s);
    if (d == nullptr || !d->m_bConnected) return ScopeError(Enum_Scope_ErrorCode::NOT_CONNECTED);
...
ScopeError CMDO34Plugin::queryLine(U32BIT s, const QByteArray& cmd, QByteArray& resp)
{
...
ScopeError CMDO34Plugin::readBinaryBlock(U32BIT s, QByteArray& payload)
{
    payload.clear();
    S_DeviceInstance* d = dev(s);
    if (d == nullptr || !d->m_bConnected) return ScopeError(Enum_Scope_ErrorCode::NOT_CONNECTED);
...
ScopeError CMDO34Plugin::sendChecked(U32BIT s, const QByteArray& cmd)
{
    ScopeError e = writeLine(s, cmd);
    if (!e.isSuccess()) return e;
    QByteArray resp;
...
ScopeError CMDO34Plugin::queryDouble(U32BIT s, const QByteArray& cmd, FDOUBLE& o)
{
    QByteArray resp;
    ...
    if (!ok) return ScopeError(Enum_Scope_ErrorCode::INVALID_RESPONSE,
                               QStringLiteral("bad numeric response \"%1\"").arg(QString::fromLatin1(resp)));
    o = v;
    return ScopeError();
}

ScopeError CMDO34Plugin::setDouble(U32BIT s, const char* scpi, FDOUBLE v, FDOUBLE lo, FDOUBLE hi, const char* what)
{
    if (v < lo || v > hi)
 ...
 *  Connection
 *==========================================================================*/
ScopeError CMDO34Plugin::connect(U32BIT s, const S_Scope_ConnectionConfig& c)
{
...
ScopeError CMDO34Plugin::disconnect(U32BIT s)
{
    S_DeviceInstance* d = dev(s);
...
bool CMDO34Plugin::isConnected(U32BIT s) const
{
    auto it = m_devices.find(s);
    return it != m_devices.end() && it.value().m_bConnected;
}

ScopeError CMDO34Plugin::reset(U32BIT s)          { return sendChecked(s, QByteArrayLiteral("*RST")); }
ScopeError CMDO34Plugin::clearStatus(U32BIT s)    { return writeLine(s, QByteArrayLiteral("*CLS")); }

ScopeError CMDO34Plugin::setTimeout(U32BIT s, U32BIT t)
{
    S_DeviceInstance* d = dev(s);
    if (d == nullptr) return ScopeError(Enum_Scope_ErrorCode::NOT_CONNECTED);
    d->m_u32Timeout = t;
...
ScopeError CMDO34Plugin::getIdentification(U32BIT s, QString& o)
{
    QByteArray r; ScopeError e = queryLine(s, QByteArrayLiteral("*IDN?"), r);
    if (e.isSuccess()) o = QString::fromLatin1(r).trimmed();
    return e;
}
ScopeError CMDO34Plugin::selfTest(U32BIT s, S32BIT& o)
{
    FDOUBLE d = 0; ScopeError e = queryDouble(s, QByteArrayLiteral("*TST?"), d);
    if (e.isSuccess()) o = static_cast<S32BIT>(d);
    return e;
}
ScopeError CMDO34Plugin::getOptions(U32BIT s, QString& o)
{
    QByteArray r; ScopeError e = queryLine(s, QByteArrayLiteral("*OPT?"), r);
    if (e.isSuccess()) o = QString::fromLatin1(r).trimmed();
    return e;
}
ScopeError CMDO34Plugin::waitOperationComplete(U32BIT s)
{
    QByteArray r; return queryLine(s, QByteArrayLiteral("*OPC?"), r);
}
ScopeError CMDO34Plugin::getScpiVersion(U32BIT s, QString& o)
{
...
ScopeError CMDO34Plugin::getParameterRange(U32BIT s, U32BIT c, Enum_Scope_ParamId p, S_Scope_ParameterRange& o)
{
    if (!isConnected(s)) return ScopeError(Enum_Scope_ErrorCode::NOT_CONNECTED);
    ...
    case Enum_Scope_ParamId::m_enumVerticalScale:
        o.m_dMin = L->m_dVertScaleMin; o.m_dMax = L->m_dVertScaleMax; o.m_dResolution = 1.0e-3; break;
    case Enum_Scope_ParamId::m_enumVerticalOffset:
    case Enum_Scope_ParamId::m_enumVerticalPosition:
        o.m_dMin = -L->m_dVertOffsetMax; o.m_dMax = L->m_dVertOffsetMax; break;
    case Enum_Scope_ParamId::m_enumTimebaseScale:
        o.m_dMin = L->m_dTimebaseMin; o.m_dMax = L->m_dTimebaseMax; break;
    case Enum_Scope_ParamId::m_enumTriggerLevel:
        o.m_dMin = -L->m_dVertOffsetMax; o.m_dMax = L->m_dVertOffsetMax; break;
    case Enum_Scope_ParamId::m_enumTriggerHoldoff:
        o.m_dMin = L->m_dTrigHoldoffMin; o.m_dMax = L->m_dTrigHoldoffMax; break;
    ...
    case Enum_Scope_ParamId::m_enumSampleRate:
        o.m_dMin = 1.0; o.m_dMax = L->m_dMaxSampleRate; break;
    case Enum_Scope_ParamId::m_enumMemoryDepth:
        o.m_dMin = 1.0; o.m_dMax = static_cast<double>(L->m_u32MaxMemoryDepth); break;
    case Enum_Scope_ParamId::m_enumAverageCount:
        o.m_dMin = 1.0; o.m_dMax = static_cast<double>(L->m_iAvgCountMax); break;
...
ScopeError CMDO34Plugin::autoscale(U32BIT s)    { return sendChecked(s, QByteArrayLiteral("AUTOSet EXECute")); }
ScopeError CMDO34Plugin::run(U32BIT s)
{
    ScopeError e = sendChecked(s, QByteArrayLiteral("ACQuire:STATE RUN"));
    if (e.isSuccess()) { S_DeviceInstance* d = dev(s); if (d) d->m_bRunning = true; }
    return e;
}
ScopeError CMDO34Plugin::stop(U32BIT s)
{
    ScopeError e = sendChecked(s, QByteArrayLiteral("ACQuire:STATE STOP"));
    if (e.isSuccess()) { S_DeviceInstance* d = dev(s); if (d) d->m_bRunning = false; }
    return e;
}
ScopeError CMDO34Plugin::single(U32BIT s)
{
    ...
    if (e.isSuccess()) { S_DeviceInstance* d = dev(s); if (d) d->m_bRunning = false; }  // single completes
    return e;
}
ScopeError CMDO34Plugin::forceTrigger(U32BIT s) { return sendChecked(s, QByteArrayLiteral("TRIGger FORCe")); }

/*============================================================================
 *  Vertical
 *==========================================================================*/
ScopeError CMDO34Plugin::enableChannel(U32BIT s, U32BIT c, bool v)
{
...
ScopeError CMDO34Plugin::isChannelEnabled(U32BIT s, U32BIT c, bool& o)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    FDOUBLE d = 0; ScopeError e = queryDouble(s, QByteArray("SELect:CH") + QByteArray::number(c) + "?", d);
    if (e.isSuccess()) o = (d != 0.0);
    return e;
}
ScopeError CMDO34Plugin::setVerticalScale(U32BIT s, U32BIT c, FDOUBLE v)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    return setDouble(s, (QByteArray("CH") + QByteArray::number(c) + ":SCAle").constData(),
                     v, m_pLimits->m_dVertScaleMin, m_pLimits->m_dVertScaleMax, "vertical scale");
}
ScopeError CMDO34Plugin::getVerticalScale(U32BIT s, U32BIT c, FDOUBLE& o)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    return queryDouble(s, QByteArray("CH") + QByteArray::number(c) + ":SCAle?", o);
}
ScopeError CMDO34Plugin::setVerticalOffset(U32BIT s, U32BIT c, FDOUBLE v)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    return setDouble(s, (QByteArray("CH") + QByteArray::number(c) + ":OFFSet").constData(),
                     v, -m_pLimits->m_dVertOffsetMax, m_pLimits->m_dVertOffsetMax, "vertical offset");
}
ScopeError CMDO34Plugin::getVerticalOffset(U32BIT s, U32BIT c, FDOUBLE& o)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    return queryDouble(s, QByteArray("CH") + QByteArray::number(c) + ":OFFSet?", o);
}
ScopeError CMDO34Plugin::setVerticalPosition(U32BIT s, U32BIT c, FDOUBLE v)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    return sendChecked(s, QByteArray("CH") + QByteArray::number(c) + ":POSition " + fmtD(v));
}
ScopeError CMDO34Plugin::getVerticalPosition(U32BIT s, U32BIT c, FDOUBLE& o)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    return queryDouble(s, QByteArray("CH") + QByteArray::number(c) + ":POSition?", o);
}
ScopeError CMDO34Plugin::setCoupling(U32BIT s, U32BIT c, Enum_Scope_Coupling v)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    const char* tok = (v == Enum_Scope_Coupling::m_enumAC) ? "AC"
                    : (v == Enum_Scope_Coupling::m_enumGND) ? "GND" : "DC";
    return sendChecked(s, QByteArray("CH") + QByteArray::number(c) + ":COUPling " + tok);
}
ScopeError CMDO34Plugin::getCoupling(U32BIT s, U32BIT c, Enum_Scope_Coupling& o)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    QByteArray r; ScopeError e = queryLine(s, QByteArray("CH") + QByteArray::number(c) + ":COUPling?", r);
    if (!e.isSuccess()) return e;
...
ScopeError CMDO34Plugin::setProbeAttenuation(U32BIT s, U32BIT c, FDOUBLE v)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    bool found = false;
    for (int i = 0; i < ScopeShared::PROBE_ATTEN_COUNT; ++i)
        if (std::fabs(v - ScopeShared::PROBE_ATTEN_VALUES[i]) < 1e-9) { found = true; break; }
    if (!found) return ScopeError(Enum_Scope_ErrorCode::PARAMETER_OUT_OF_RANGE,
...
ScopeError CMDO34Plugin::getProbeAttenuation(U32BIT s, U32BIT c, FDOUBLE& o)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    FDOUBLE gain = 0; ScopeError e = queryDouble(s, QByteArray("CH") + QByteArray::number(c) + ":PRObe:GAIN?", gain);
    if (!e.isSuccess()) return e;
 ...
 *  Horizontal
 *==========================================================================*/
ScopeError CMDO34Plugin::setTimebaseScale(U32BIT s, FDOUBLE v)
{
    return setDouble(s, "HORizontal:SCAle", v, m_pLimits->m_dTimebaseMin, m_pLimits->m_dTimebaseMax, "timebase scale");
}
ScopeError CMDO34Plugin::getTimebaseScale(U32BIT s, FDOUBLE& o)
{ return queryDouble(s, QByteArrayLiteral("HORizontal:SCAle?"), o); }
ScopeError CMDO34Plugin::setTimebasePosition(U32BIT s, FDOUBLE v)
{ return sendChecked(s, QByteArray("HORizontal:DELay:TIMe ") + fmtD(v)); }
ScopeError CMDO34Plugin::getTimebasePosition(U32BIT s, FDOUBLE& o)
{ return queryDouble(s, QByteArrayLiteral("HORizontal:DELay:TIMe?"), o); }
ScopeError CMDO34Plugin::getSampleRate(U32BIT s, FDOUBLE& o)
{
    FDOUBLE sr = 0; ScopeError e = queryDouble(s, QByteArrayLiteral("HORizontal:SAMPLERate?"), sr);
    if (!e.isSuccess()) return e;
    if (sr <= 0.0) {
        FDOUBLE tb = 0; getTimebaseScale(s, tb);
        U32BIT pts = 1000; getMemoryDepth(s, pts);
...
ScopeError CMDO34Plugin::setMemoryDepth(U32BIT s, U32BIT v)
{
    if (v < 1 || v > m_pLimits->m_u32MaxMemoryDepth)
        return ScopeError(Enum_Scope_ErrorCode::PARAMETER_OUT_OF_RANGE,
            QStringLiteral("memory depth %1 out of range [1 .. %2]").arg(v).arg(m_pLimits->m_u32MaxMemoryDepth));
    return sendChecked(s, QByteArray("HORizontal:RECOrdlength ") + QByteArray::number(v));
}
ScopeError CMDO34Plugin::getMemoryDepth(U32BIT s, U32BIT& o)
{
    FDOUBLE d = 0; ScopeError e = queryDouble(s, QByteArrayLiteral("HORizontal:RECOrdlength?"), d);
    if (!e.isSuccess()) return e;
 ...
 *  Trigger
 *==========================================================================*/
ScopeError CMDO34Plugin::setTriggerMode(U32BIT s, Enum_Scope_TriggerMode v)
{
...
ScopeError CMDO34Plugin::getTriggerMode(U32BIT s, Enum_Scope_TriggerMode& o)
{
    QByteArray r; ScopeError e = queryLine(s, QByteArrayLiteral("TRIGger:A:MODe?"), r);
    if (!e.isSuccess()) return e;
...
ScopeError CMDO34Plugin::setTriggerSource(U32BIT s, Enum_Scope_TriggerSource v)
{ return sendChecked(s, QByteArray("TRIGger:A:EDGE:SOUrce ") + srcTok(v)); }
ScopeError CMDO34Plugin::getTriggerSource(U32BIT s, Enum_Scope_TriggerSource& o)
{
    QByteArray r; ScopeError e = queryLine(s, QByteArrayLiteral("TRIGger:A:EDGE:SOUrce?"), r);
    if (!e.isSuccess()) return e;
    const QString t = QString::fromLatin1(r).trimmed().toUpper();
    if (t.contains(QStringLiteral("CH2"))) o = Enum_Scope_TriggerSource::m_enumCh2;
    else if (t.contains(QStringLiteral("CH3"))) o = Enum_Scope_TriggerSource::m_enumCh3;
    else if (t.contains(QStringLiteral("CH4"))) o = Enum_Scope_TriggerSource::m_enumCh4;
    else if (t.contains(QStringLiteral("AUX")) || t.contains(QStringLiteral("EXT"))) o = Enum_Scope_TriggerSource::m_enumExt;
    else if (t.contains(QStringLiteral("LINE"))) o = Enum_Scope_TriggerSource::m_enumLine;
    else o = Enum_Scope_TriggerSource::m_enumCh1;
    return ScopeError();
}
ScopeError CMDO34Plugin::setTriggerSlope(U32BIT s, Enum_Scope_TriggerSlope v)
{
    const char* tok = (v == Enum_Scope_TriggerSlope::m_enumFalling) ? "FALL"
                    : (v == Enum_Scope_TriggerSlope::m_enumEither) ? "EITher" : "RISe";
    return sendChecked(s, QByteArray("TRIGger:A:EDGE:SLOpe ") + tok);
}
ScopeError CMDO34Plugin::getTriggerSlope(U32BIT s, Enum_Scope_TriggerSlope& o)
{
    QByteArray r; ScopeError e = queryLine(s, QByteArrayLiteral("TRIGger:A:EDGE:SLOpe?"), r);
    if (!e.isSuccess()) return e;
    const QString t = QString::fromLatin1(r).trimmed().toUpper();
...
ScopeError CMDO34Plugin::setTriggerLevel(U32BIT s, U32BIT c, FDOUBLE v)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    return sendChecked(s, QByteArray("TRIGger:A:LEVel:CH") + QByteArray::number(c) + " " + fmtD(v));
}
ScopeError CMDO34Plugin::getTriggerLevel(U32BIT s, U32BIT c, FDOUBLE& o)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    return queryDouble(s, QByteArray("TRIGger:A:LEVel:CH") + QByteArray::number(c) + "?", o);
}
ScopeError CMDO34Plugin::setTriggerHoldoff(U32BIT s, FDOUBLE v)
{
    return setDouble(s, "TRIGger:A:HOLDoff:TIMe", v, m_pLimits->m_dTrigHoldoffMin, m_pLimits->m_dTrigHoldoffMax, "holdoff");
}
ScopeError CMDO34Plugin::getTriggerHoldoff(U32BIT s, FDOUBLE& o)
{ return queryDouble(s, QByteArrayLiteral("TRIGger:A:HOLDoff:TIMe?"), o); }
ScopeError CMDO34Plugin::getTriggerState(U32BIT s, Enum_Scope_TriggerState& o)
{
    QByteArray r; ScopeError e = queryLine(s, QByteArrayLiteral("TRIGger:STATE?"), r);
    if (!e.isSuccess()) return e;
    const QString t = QString::fromLatin1(r).trimmed().toUpper();
    if (t.contains(QStringLiteral("TRIG")) || t.contains(QStringLiteral("SAVE"))) o = Enum_Scope_TriggerState::m_enumTriggered;
    else if (t.contains(QStringLiteral("READY")) || t.contains(QStringLiteral("ARM"))) o = Enum_Scope_TriggerState::m_enumReady;
    else if (t.contains(QStringLiteral("AUTO"))) o = Enum_Scope_TriggerState::m_enumAuto;
 ...
 *  Acquisition
 *==========================================================================*/
ScopeError CMDO34Plugin::setAcqMode(U32BIT s, Enum_Scope_AcqMode v)
{
    const char* tok = "SAMple";
    switch (v) {
    case Enum_Scope_AcqMode::m_enumPeakDetect: tok = "PEAKdetect"; break;
    case Enum_Scope_AcqMode::m_enumAverage:    tok = "AVErage"; break;
    case Enum_Scope_AcqMode::m_enumHiRes:      tok = "HIRes"; break;
    case Enum_Scope_AcqMode::m_enumEnvelope:   tok = "ENVelope"; break;
    default: break;
    }
    return sendChecked(s, QByteArray("ACQuire:MODe ") + tok);
}
ScopeError CMDO34Plugin::getAcqMode(U32BIT s, Enum_Scope_AcqMode& o)
{
    QByteArray r; ScopeError e = queryLine(s, QByteArrayLiteral("ACQuire:MODe?"), r);
    if (!e.isSuccess()) return e;
    const QString t = QString::fromLatin1(r).trimmed().toUpper();
    if (t.startsWith(QStringLiteral("PEAK"))) o = Enum_Scope_AcqMode::m_enumPeakDetect;
    else if (t.startsWith(QStringLiteral("AVE"))) o = Enum_Scope_AcqMode::m_enumAverage;
    else if (t.startsWith(QStringLiteral("HIR"))) o = Enum_Scope_AcqMode::m_enumHiRes;
    else if (t.startsWith(QStringLiteral("ENV"))) o = Enum_Scope_AcqMode::m_enumEnvelope;
    else o = Enum_Scope_AcqMode::m_enumSample;
    return ScopeError();
}
ScopeError CMDO34Plugin::setAverageCount(U32BIT s, U32BIT v)
{
...
ScopeError CMDO34Plugin::getAverageCount(U32BIT s, U32BIT& o)
{
    FDOUBLE d = 0; ScopeError e = queryDouble(s, QByteArrayLiteral("ACQuire:NUMAVg?"), d);
    if (e.isSuccess()) o = static_cast<U32BIT>(d);
    return e;
}
ScopeError CMDO34Plugin::getAcquisitionState(U32BIT s, Enum_Scope_AcqState& o)
{
    S_DeviceInstance* d = dev(s);
    if (d == nullptr || !d->m_bConnected) return ScopeError(Enum_Scope_ErrorCode::NOT_CONNECTED);
 ...
 *  Waveform
 *==========================================================================*/
ScopeError CMDO34Plugin::setWaveformSource(U32BIT s, Enum_Scope_WaveformSource v, U32BIT i)
{
    if (v != Enum_Scope_WaveformSource::m_enumChannel)
        return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED, QStringLiteral("only channel source implemented"));
...
ScopeError CMDO34Plugin::setWaveformFormat(U32BIT s, Enum_Scope_WaveformFormat v)
{
...
ScopeError CMDO34Plugin::setWaveformPoints(U32BIT s, U32BIT v)
{
    if (v < 1 || v > m_pLimits->m_u32MaxMemoryDepth)
        return ScopeError(Enum_Scope_ErrorCode::PARAMETER_OUT_OF_RANGE,
...
ScopeError CMDO34Plugin::getWaveformPreamble(U32BIT s, U32BIT c, S_Scope_WaveformPreamble& o)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    QByteArray r; ScopeError e = queryLine(s, QByteArrayLiteral("WFMOutpre?"), r);
    if (!e.isSuccess()) return e;
    const QList<QByteArray> f = r.trimmed().split(',');
    if (f.size() < 10) return ScopeError(Enum_Scope_ErrorCode::INVALID_RESPONSE, QStringLiteral("short preamble"));
...
ScopeError CMDO34Plugin::readWaveform(U32BIT s, U32BIT c, S_Scope_Waveform& o)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    ...
    for (int i = 0; i < n; ++i) {
        const qint16 code = static_cast<qint16>(
            (static_cast<quint8>(payload[2 * i]) << 8) | static_cast<quint8>(payload[2 * i + 1]));
...
ScopeError CMDO34Plugin::digitizeChannel(U32BIT s, U32BIT c)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    return single(s);
}
 ...
 *  Status
 *==========================================================================*/
ScopeError CMDO34Plugin::readErrorStatus(U32BIT s, U32BIT, S_Scope_DeviceErrorStatus& o)
{
    o = S_Scope_DeviceErrorStatus();
    FDOUBLE esr = 0; ScopeError e = queryDouble(s, QByteArrayLiteral("*ESR?"), esr);
    if (!e.isSuccess()) return e;
    ...
    o.m_statusFlags |= (acq == Enum_Scope_AcqState::m_enumRunning)
            ? Enum_Scope_DeviceStatusFlag::Running : Enum_Scope_DeviceStatusFlag::Stopped;
    QByteArray q; queryLine(s, QByteArrayLiteral("SYST:ERR?"), q);
    o.m_StrErrorMessage = QString::fromLatin1(q).trimmed();
    return ScopeError();
}
ScopeError CMDO34Plugin::clearErrorStatus(U32BIT s, U32BIT) { return writeLine(s, QByteArrayLiteral("*CLS")); }
ScopeError CMDO34Plugin::queryErrorQueue(U32BIT s, QString& o)
{
    QByteArray r; ScopeError e = queryLine(s, QByteArrayLiteral("SYST:ERR?"), r);
    if (e.isSuccess()) o = QString::fromLatin1(r).trimmed();
    return e;
}
ScopeError CMDO34Plugin::readStatusByte(U32BIT s, U32BIT& o)
{
    FDOUBLE d = 0; ScopeError e = queryDouble(s, QByteArrayLiteral("*STB?"), d);
    if (e.isSuccess()) o = static_cast<U32BIT>(d);
    return e;
}
ScopeError CMDO34Plugin::readStandardEventStatus(U32BIT s, U32BIT& o)
{
    FDOUBLE d = 0; ScopeError e = queryDouble(s, QByteArrayLiteral("*ESR?"), d);
    if (e.isSuccess()) o = static_cast<U32BIT>(d);
    return e;
}
ScopeError CMDO34Plugin::writeScpi(U32BIT s, const QString& v) { return writeLine(s, v.toLatin1()); }
ScopeError CMDO34Plugin::queryScpi(U32BIT s, const QString& v, QString& o)
{
    QByteArray r; ScopeError e = queryLine(s, v.toLatin1(), r);
    if (e.isSuccess()) o = QString::fromLatin1(r).trimmed();
    return e;
}
...
ScopeError CMDO34Plugin::addMeasurement(U32BIT s, U32BIT c, Enum_Scope_MeasType t)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CMDO34Plugin::readMeasurement(U32BIT s, U32BIT c, Enum_Scope_MeasType t, S_Scope_MeasurementResult& o)
{
...
ScopeError CMDO34Plugin::clearMeasurements(U32BIT s) { return writeLine(s, QByteArrayLiteral("MEASUrement:CLEAR")); }
ScopeError CMDO34Plugin::setMeasureStatistics(U32BIT s, bool v)
{ return sendChecked(s, QByteArray("MEASUrement:STATIstics:MODe ") + (v ? "ALL" : "OFF")); }
ScopeError CMDO34Plugin::getMeasurementStatistics(U32BIT s, U32BIT c, Enum_Scope_MeasType t, S_Scope_MeasurementResult& o)
{ return readMeasurement(s, c, t, o); }

ScopeError CMDO34Plugin::setCursorType(U32BIT s, Enum_Scope_CursorType v)
{
...
ScopeError CMDO34Plugin::getCursorType(U32BIT s, Enum_Scope_CursorType& o)
{
...
ScopeError CMDO34Plugin::setCursorSource(U32BIT s, U32BIT c)
{ if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
  return sendChecked(s, QByteArray("CURSor:SOUrce CH") + QByteArray::number(c)); }
ScopeError CMDO34Plugin::setCursorPosition(U32BIT s, U32BIT i, FDOUBLE v)
{ return sendChecked(s, QByteArray("CURSor:VBArs:POSITION") + QByteArray::number(i == 0 ? 1 : i) + " " + fmtD(v)); }
ScopeError CMDO34Plugin::getCursorPosition(U32BIT s, U32BIT i, FDOUBLE& o)
{ return queryDouble(s, QByteArray("CURSor:VBArs:POSITION") + QByteArray::number(i == 0 ? 1 : i) + "?", o); }
ScopeError CMDO34Plugin::readCursorValues(U32BIT s, FDOUBLE& x1, FDOUBLE& x2, FDOUBLE& y1, FDOUBLE& y2)
{
...
ScopeError CMDO34Plugin::setMathOperation(U32BIT s, Enum_Scope_MathOp v)
{ return sendChecked(s, QByteArray("MATH:TYPe ") + ((v == Enum_Scope_MathOp::m_enumFFT) ? "FFT" : "DUAl")); }
ScopeError CMDO34Plugin::setMathSource1(U32BIT s, U32BIT c)
{ if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
  return sendChecked(s, QByteArray("MATH:SOURCE1 CH") + QByteArray::number(c)); }
ScopeError CMDO34Plugin::setMathSource2(U32BIT s, U32BIT c)
{ if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
  return sendChecked(s, QByteArray("MATH:SOURCE2 CH") + QByteArray::number(c)); }
ScopeError CMDO34Plugin::enableMath(U32BIT s, bool v) { return sendChecked(s, QByteArray("SELect:MATH ") + (v ? "ON" : "OFF")); }
ScopeError CMDO34Plugin::setFftWindow(U32BIT s, Enum_Scope_FftWindow v)
{
...
ScopeError CMDO34Plugin::getFftWindow(U32BIT s, Enum_Scope_FftWindow& o)
{
...
ScopeError CMDO34Plugin::setFftSpan(U32BIT s, FDOUBLE v)  { return sendChecked(s, QByteArray("MATH:FFT:HORizontal:SPAN ") + fmtD(v)); }
ScopeError CMDO34Plugin::setFftCenter(U32BIT s, FDOUBLE v){ return sendChecked(s, QByteArray("MATH:FFT:HORizontal:CENTer ") + fmtD(v)); }
ScopeError CMDO34Plugin::setMathScale(U32BIT s, FDOUBLE v)   { return sendChecked(s, QByteArray("MATH:VERTical:SCAle ") + fmtD(v)); }
ScopeError CMDO34Plugin::setMathPosition(U32BIT s, FDOUBLE v){ return sendChecked(s, QByteArray("MATH:VERTical:POSition ") + fmtD(v)); }

ScopeError CMDO34Plugin::setPersistence(U32BIT s, FDOUBLE v) { return sendChecked(s, QByteArray("DISplay:PERSistence ") + fmtD(v)); }
ScopeError CMDO34Plugin::setGraticule(U32BIT s, const QString& v) { return sendChecked(s, QByteArray("DISplay:GRAticule ") + v.toLatin1()); }
ScopeError CMDO34Plugin::setIntensity(U32BIT s, FDOUBLE v) { return sendChecked(s, QByteArray("DISplay:INTENSITy:WAVEform ") + fmtD(v)); }
ScopeError CMDO34Plugin::setDisplayFormat(U32BIT s, Enum_Scope_TimebaseMode v)
{ return sendChecked(s, QByteArray("DISplay:FORMat ") + ((v == Enum_Scope_TimebaseMode::m_enumXY) ? "XY" : "YT")); }
ScopeError CMDO34Plugin::setVectors(U32BIT s, bool v) { return sendChecked(s, QByteArray("DISplay:STYLE:DOTsonly ") + (v ? "OFF" : "ON")); }

ScopeError CMDO34Plugin::saveSetup(U32BIT s, U32BIT loc)  { return sendChecked(s, QByteArray("*SAV ") + QByteArray::number(loc)); }
ScopeError CMDO34Plugin::recallSetup(U32BIT s, U32BIT loc){ return sendChecked(s, QByteArray("*RCL ") + QByteArray::number(loc)); }
ScopeError CMDO34Plugin::saveWaveformToFile(U32BIT s, U32BIT c, const QString& path)
{ if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
  return sendChecked(s, QByteArray("SAVe:WAVEform CH") + QByteArray::number(c) + ",\"" + path.toLatin1() + "\""); }
ScopeError CMDO34Plugin::captureScreenshot(U32BIT s, Enum_Scope_ImageFormat, QByteArray& o)
{
    ScopeError e = writeLine(s, QByteArrayLiteral("HARDCopy STARt"));
    if (!e.isSuccess()) return e;
    return readBinaryBlock(s, o);
}
ScopeError CMDO34Plugin::saveToReference(U32BIT s, U32BIT c, U32BIT slot)
{ if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
  return sendChecked(s, QByteArray("SAVe:WAVEform CH") + QByteArray::number(c) + ",REF" + QByteArray::number(slot)); }
ScopeError CMDO34Plugin::displayReference(U32BIT s, U32BIT slot, bool v)
{ return sendChecked(s, QByteArray("SELect:REF") + QByteArray::number(slot) + (v ? " ON" : " OFF")); }

ScopeError CMDO34Plugin::enableDigitalChannel(U32BIT s, U32BIT d, bool v)
...
ScopeError CMDO34Plugin::setDigitalThreshold(U32BIT s, U32BIT d, FDOUBLE v)
{ if (!m_pLimits->m_bHasDigital) return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
  return sendChecked(s, QByteArray("DIGital:THRESHold:D") + QByteArray::number(d) + " " + fmtD(v)); }
ScopeError CMDO34Plugin::setPodThreshold(U32BIT s, U32BIT p, FDOUBLE v)
{ if (!m_pLimits->m_bHasDigital) return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
  return sendChecked(s, QByteArray("DIGital:POD") + QByteArray::number(p) + ":THRESHold " + fmtD(v)); }
ScopeError CMDO34Plugin::enableBus(U32BIT s, U32BIT b, bool v)
...
ScopeError CMDO34Plugin::setBusType(U32BIT s, U32BIT b, const QString& v)
{ if (!m_pLimits->m_bHasSerialDecode) return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
  return sendChecked(s, QByteArray("BUS:B") + QByteArray::number(b) + ":TYPe " + v.toLatin1()); }
ScopeError CMDO34Plugin::readBusDecode(U32BIT s, U32BIT b, QString& o)
{ if (!m_pLimits->m_bHasSerialDecode) return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
...
ScopeError CMDO34Plugin::setAwgFunction(U32BIT s, const QString& v)
...
ScopeError CMDO34Plugin::setAwgFrequency(U32BIT s, FDOUBLE v)
{ if (!m_pLimits->m_bHasAWG) return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
...
ScopeError CMDO34Plugin::setAwgAmplitude(U32BIT s, FDOUBLE v)
{ if (!m_pLimits->m_bHasAWG) return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
...
ScopeError CMDO34Plugin::setAwgOffset(U32BIT s, FDOUBLE v)
{ if (!m_pLimits->m_bHasAWG) return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
  return sendChecked(s, QByteArray("AFG:OFFSet ") + fmtD(v)); }
ScopeError CMDO34Plugin::enableAwgOutput(U32BIT s, bool v)
{ if (!m_pLimits->m_bHasAWG) return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
  return sendChecked(s, QByteArray("AFG:OUTPut:STATE ") + (v ? "ON" : "OFF")); }

ScopeError CMDO34Plugin::readOperationStatus(U32BIT s, U32BIT& o)
{ FDOUBLE d = 0; ScopeError e = queryDouble(s, QByteArrayLiteral("BUSY?"), d); o = e.isSuccess() ? static_cast<U32BIT>(d) : 0u; return ScopeError(); }
ScopeError CMDO34Plugin::readQuestionableStatus(U32BIT s, U32BIT& o)
{ (void)s; o = 0u; return ScopeError(); }
ScopeError CMDO34Plugin::getInstrumentErrorCount(U32BIT s, U32BIT& o)
...
ScopeError CMDO34Plugin::setRemoteState(U32BIT s, Enum_Scope_RemoteState v)
{ return sendChecked(s, QByteArray("LOCk ") + ((v == Enum_Scope_RemoteState::m_enumLocal) ? "NONe" : "ALL")); }
ScopeError CMDO34Plugin::getRemoteState(U32BIT s, Enum_Scope_RemoteState& o)
{ QByteArray r; ScopeError e = queryLine(s, QByteArrayLiteral("LOCk?"), r); if (!e.isSuccess()) return e;
  ...
  return ScopeError(); }
ScopeError CMDO34Plugin::setKeyLock(U32BIT s, bool v) { return sendChecked(s, QByteArray("LOCk ") + (v ? "ALL" : "NONe")); }
ScopeError CMDO34Plugin::isKeyLocked(U32BIT s, bool& o)
{ QByteArray r; ScopeError e = queryLine(s, QByteArrayLiteral("LOCk?"), r); if (!e.isSuccess()) return e;
  o = !QString::fromLatin1(r).trimmed().toUpper().startsWith(QStringLiteral("NON")); return ScopeError(); }
ScopeError CMDO34Plugin::setBeeper(U32BIT s, bool v) { (void)v; return writeLine(s, QByteArrayLiteral("*CLS")); }
