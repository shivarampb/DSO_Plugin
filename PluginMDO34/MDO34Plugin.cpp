...
CMDO34Plugin::CMDO34Plugin()
    : m_limits{"MDO34", "Tektronix", "3 Series MDO", "MDO3",  4,      16,   1.0e9,
               5.0e9,   10000000u, /* 5 GS/s, 10 M record - verified vs datasheet */
               1.0e-3,  10.0,        100.0,          4.0e-10, 1000.0, 0.0,  10.0,
               512,     true,        true,           true,    true,   true, 5.0e7,
               5.0,     "0x0699",    "0x0522"},
      m_pLimits(&m_limits), m_strModel(QStringLiteral("MDO34"))
{
}
...
ScopeError CMDO34Plugin::setDouble(U32BIT s, const char* scpi, FDOUBLE v, FDOUBLE lo, FDOUBLE hi,
                                   const char* what)
{
    if (v < lo || v > hi)
    {
...
ScopeError CMDO34Plugin::reset(U32BIT s)
{
    return sendChecked(s, QByteArrayLiteral("*RST"));
}
ScopeError CMDO34Plugin::clearStatus(U32BIT s)
{
...
ScopeError CMDO34Plugin::getParameterRange(U32BIT s, U32BIT c, Enum_Scope_ParamId p,
...
ScopeError CMDO34Plugin::autoscale(U32BIT s)
{
...
ScopeError CMDO34Plugin::forceTrigger(U32BIT s)
{
...
ScopeError CMDO34Plugin::clearErrorStatus(U32BIT s, U32BIT)
{
    return writeLine(s, QByteArrayLiteral("*CLS"));
}
...
ScopeError CMDO34Plugin::writeScpi(U32BIT s, const QString& v)
{
...
ScopeError CMDO34Plugin::readMeasurement(U32BIT s, U32BIT c, Enum_Scope_MeasType t,
...
ScopeError CMDO34Plugin::clearMeasurements(U32BIT s)
{
...
ScopeError CMDO34Plugin::getMeasurementStatistics(U32BIT s, U32BIT c, Enum_Scope_MeasType t,
                                                  S_Scope_MeasurementResult& o)
{
...
ScopeError CMDO34Plugin::enableMath(U32BIT s, bool v)
{
...
ScopeError CMDO34Plugin::setFftSpan(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray("MATH:FFT:HORizontal:SPAN ") + fmtD(v));
}
ScopeError CMDO34Plugin::setFftCenter(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray("MATH:FFT:HORizontal:CENTer ") + fmtD(v));
}
ScopeError CMDO34Plugin::setMathScale(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray("MATH:VERTical:SCAle ") + fmtD(v));
}
ScopeError CMDO34Plugin::setMathPosition(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray("MATH:VERTical:POSition ") + fmtD(v));
}

ScopeError CMDO34Plugin::setPersistence(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray("DISplay:PERSistence ") + fmtD(v));
}
ScopeError CMDO34Plugin::setGraticule(U32BIT s, const QString& v)
{
    return sendChecked(s, QByteArray("DISplay:GRAticule ") + v.toLatin1());
}
ScopeError CMDO34Plugin::setIntensity(U32BIT s, FDOUBLE v)
{
...
ScopeError CMDO34Plugin::setVectors(U32BIT s, bool v)
{
    return sendChecked(s, QByteArray("DISplay:STYLE:DOTsonly ") + (v ? "OFF" : "ON"));
}

ScopeError CMDO34Plugin::saveSetup(U32BIT s, U32BIT loc)
{
    return sendChecked(s, QByteArray("*SAV ") + QByteArray::number(loc));
}
ScopeError CMDO34Plugin::recallSetup(U32BIT s, U32BIT loc)
{
...
ScopeError CMDO34Plugin::setKeyLock(U32BIT s, bool v)
{
...
ScopeError CMDO34Plugin::setBeeper(U32BIT s, bool v)
{
    (void)v;
    return writeLine(s, QByteArrayLiteral("*CLS"));
}
