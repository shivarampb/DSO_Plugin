...
CRTO2064Plugin::CRTO2064Plugin()
    : m_pLimits(nullptr)
    , m_strModel(QStringLiteral("RTO2064"))
{
...
ScopeError CRTO2064Plugin::setDouble(U32BIT s, const char* scpi, FDOUBLE v, FDOUBLE lo, FDOUBLE hi, const char* what)
{
    if (v < lo || v > hi)
...
ScopeError CRTO2064Plugin::reset(U32BIT s)       { return sendChecked(s, QByteArrayLiteral("*RST")); }
ScopeError CRTO2064Plugin::clearStatus(U32BIT s) { return writeLine(s, QByteArrayLiteral("*CLS")); }
...
ScopeError CRTO2064Plugin::getParameterRange(U32BIT s, U32BIT c, Enum_Scope_ParamId p, S_Scope_ParameterRange& o)
{
    if (!isConnected(s)) return ScopeError(Enum_Scope_ErrorCode::NOT_CONNECTED);
...
ScopeError CRTO2064Plugin::autoscale(U32BIT s)    { return sendChecked(s, QByteArrayLiteral("AUToscale")); }
...
ScopeError CRTO2064Plugin::forceTrigger(U32BIT s) { return writeLine(s, QByteArrayLiteral("TRIGger:FORCe")); }
...
ScopeError CRTO2064Plugin::clearErrorStatus(U32BIT s, U32BIT) { return writeLine(s, QByteArrayLiteral("*CLS")); }
...
ScopeError CRTO2064Plugin::writeScpi(U32BIT s, const QString& v) { return writeLine(s, v.toLatin1()); }
...
ScopeError CRTO2064Plugin::readMeasurement(U32BIT s, U32BIT c, Enum_Scope_MeasType t, S_Scope_MeasurementResult& o)
{
...
ScopeError CRTO2064Plugin::clearMeasurements(U32BIT s) { return writeLine(s, QByteArrayLiteral("MEASurement1:AOFF")); }
...
ScopeError CRTO2064Plugin::getMeasurementStatistics(U32BIT s, U32BIT c, Enum_Scope_MeasType t, S_Scope_MeasurementResult& o)
...
ScopeError CRTO2064Plugin::enableMath(U32BIT s, bool v) { return sendChecked(s, QByteArray("CALCulate:MATH1:STATe ") + (v ? "ON" : "OFF")); }
...
ScopeError CRTO2064Plugin::setFftSpan(U32BIT s, FDOUBLE v)   { return sendChecked(s, QByteArray("CALCulate:MATH1:FFT:SPAN ") + fmtD(v)); }
ScopeError CRTO2064Plugin::setFftCenter(U32BIT s, FDOUBLE v) { return sendChecked(s, QByteArray("CALCulate:MATH1:FFT:CFRequency ") + fmtD(v)); }
ScopeError CRTO2064Plugin::setMathScale(U32BIT s, FDOUBLE v)    { return sendChecked(s, QByteArray("CALCulate:MATH1:SCALe ") + fmtD(v)); }
ScopeError CRTO2064Plugin::setMathPosition(U32BIT s, FDOUBLE v) { return sendChecked(s, QByteArray("CALCulate:MATH1:POSition ") + fmtD(v)); }
...
ScopeError CRTO2064Plugin::setGraticule(U32BIT s, const QString& v) { return sendChecked(s, QByteArray("DISPlay:DIAGram:GRID:STYLe ") + v.toLatin1()); }
ScopeError CRTO2064Plugin::setIntensity(U32BIT s, FDOUBLE v) { return sendChecked(s, QByteArray("DISPlay:INTensity:WAVeform ") + fmtD(v)); }
...
ScopeError CRTO2064Plugin::setVectors(U32BIT s, bool v) { return sendChecked(s, QByteArray("DISPlay:DIAGram:STYLe ") + (v ? "VECTors" : "DOTS")); }

ScopeError CRTO2064Plugin::saveSetup(U32BIT s, U32BIT loc)  { return sendChecked(s, QByteArray("*SAV ") + QByteArray::number(loc)); }
ScopeError CRTO2064Plugin::recallSetup(U32BIT s, U32BIT loc){ return sendChecked(s, QByteArray("*RCL ") + QByteArray::number(loc)); }
...
ScopeError CRTO2064Plugin::setKeyLock(U32BIT s, bool v) { return sendChecked(s, QByteArray("SYSTem:KLOCk ") + (v ? "ON" : "OFF")); }
...
ScopeError CRTO2064Plugin::setBeeper(U32BIT s, bool v) { return sendChecked(s, QByteArray("SYSTem:BEEPer:STATe ") + (v ? "ON" : "OFF")); }
