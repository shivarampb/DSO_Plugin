...
CMSO6054APlugin::CMSO6054APlugin() : m_pLimits(nullptr), m_strModel(QStringLiteral(KS_MODEL_NAME))
{
 ...
 * @pre    The scope slot must be connected (see connect()).
 */
ScopeError CMSO6054APlugin::setDouble(U32BIT s, const char* scpi, FDOUBLE v, FDOUBLE lo, FDOUBLE hi,
                                      const char* what)
{
    if (v < lo || v > hi)
    {
...
ScopeError CMSO6054APlugin::reset(U32BIT s)
{
    return sendChecked(s, QByteArrayLiteral("*RST"));
}
ScopeError CMSO6054APlugin::clearStatus(U32BIT s)
{
...
ScopeError CMSO6054APlugin::waitOperationComplete(U32BIT s)
{
    QByteArray r;
...
ScopeError CMSO6054APlugin::getParameterRange(U32BIT s, U32BIT c, Enum_Scope_ParamId p,
...
ScopeError CMSO6054APlugin::autoscale(U32BIT s)
{
    return sendChecked(s, QByteArrayLiteral(":AUToscale"));
}
ScopeError CMSO6054APlugin::run(U32BIT s)
{
...
ScopeError CMSO6054APlugin::stop(U32BIT s)
{
...
ScopeError CMSO6054APlugin::single(U32BIT s)
{
...
ScopeError CMSO6054APlugin::forceTrigger(U32BIT s)
{
...
ScopeError CMSO6054APlugin::getTimebaseScale(U32BIT s, FDOUBLE& o)
{
    return queryDouble(s, QByteArrayLiteral(":TIMebase:SCALe?"), o);
}
ScopeError CMSO6054APlugin::setTimebasePosition(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":TIMebase:POSition ") + fmtD(v));
}
ScopeError CMSO6054APlugin::getTimebasePosition(U32BIT s, FDOUBLE& o)
{
...
ScopeError CMSO6054APlugin::getTriggerHoldoff(U32BIT s, FDOUBLE& o)
{
...
ScopeError CMSO6054APlugin::clearErrorStatus(U32BIT s, U32BIT)
{
    return writeLine(s, QByteArrayLiteral("*CLS"));
}
...
ScopeError CMSO6054APlugin::writeScpi(U32BIT s, const QString& v)
{
...
ScopeError CMSO6054APlugin::addMeasurement(U32BIT s, U32BIT c, Enum_Scope_MeasType t)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CMSO6054APlugin::readMeasurement(U32BIT s, U32BIT c, Enum_Scope_MeasType t,
...
ScopeError CMSO6054APlugin::clearMeasurements(U32BIT s)
{
    return writeLine(s, QByteArrayLiteral(":MEASure:CLEar"));
}
ScopeError CMSO6054APlugin::setMeasureStatistics(U32BIT s, bool v)
{
    return sendChecked(s, QByteArray(":MEASure:STATistics ") + (v ? "ON" : "OFF"));
}
ScopeError CMSO6054APlugin::getMeasurementStatistics(U32BIT s, U32BIT c, Enum_Scope_MeasType t,
                                                     S_Scope_MeasurementResult& o)
{
    return readMeasurement(s, c, t, o);
}

ScopeError CMSO6054APlugin::setCursorType(U32BIT s, Enum_Scope_CursorType v)
{
...
ScopeError CMSO6054APlugin::getCursorType(U32BIT s, Enum_Scope_CursorType& o)
{
    QByteArray r;
...
ScopeError CMSO6054APlugin::setCursorSource(U32BIT s, U32BIT c)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CMSO6054APlugin::setCursorPosition(U32BIT s, U32BIT i, FDOUBLE v)
{
    return sendChecked(s,
                       QByteArray(":MARKer:X") + QByteArray::number(i == 0 ? 1 : i) + "Position " + fmtD(v));
}
ScopeError CMSO6054APlugin::getCursorPosition(U32BIT s, U32BIT i, FDOUBLE& o)
{
    return queryDouble(s, QByteArray(":MARKer:X") + QByteArray::number(i == 0 ? 1 : i) + "Position?", o);
}
ScopeError CMSO6054APlugin::readCursorValues(U32BIT s, FDOUBLE& x1, FDOUBLE& x2, FDOUBLE& y1, FDOUBLE& y2)
{
...
ScopeError CMSO6054APlugin::setMathOperation(U32BIT s, Enum_Scope_MathOp v)
{
    const char* op = "ADD";
    switch (v)
    {
...
ScopeError CMSO6054APlugin::setMathSource1(U32BIT s, U32BIT c)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CMSO6054APlugin::setMathSource2(U32BIT s, U32BIT c)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CMSO6054APlugin::enableMath(U32BIT s, bool v)
{
    return sendChecked(s, QByteArray(":FUNCtion:DISPlay ") + (v ? "ON" : "OFF"));
}
ScopeError CMSO6054APlugin::setFftWindow(U32BIT s, Enum_Scope_FftWindow v)
{
...
ScopeError CMSO6054APlugin::getFftWindow(U32BIT s, Enum_Scope_FftWindow& o)
{
    QByteArray r;
...
ScopeError CMSO6054APlugin::setFftSpan(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":FUNCtion:FFT:SPAN ") + fmtD(v));
}
ScopeError CMSO6054APlugin::setFftCenter(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":FUNCtion:FFT:CENTer ") + fmtD(v));
}
ScopeError CMSO6054APlugin::setMathScale(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":FUNCtion:SCALe ") + fmtD(v));
}
ScopeError CMSO6054APlugin::setMathPosition(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":FUNCtion:OFFSet ") + fmtD(v));
}

ScopeError CMSO6054APlugin::setPersistence(U32BIT s, FDOUBLE v)
{
    return sendChecked(s,
                       QByteArray(":DISPlay:PERSistence ") + ((v > 0.0) ? fmtD(v) : QByteArray("MINimum")));
}
ScopeError CMSO6054APlugin::setGraticule(U32BIT s, const QString& v)
{
    return sendChecked(s, QByteArray(":DISPlay:GRATicule ") + v.toLatin1());
}
ScopeError CMSO6054APlugin::setIntensity(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":DISPlay:INTensity:WAVeform ") + fmtD(v));
}
ScopeError CMSO6054APlugin::setDisplayFormat(U32BIT s, Enum_Scope_TimebaseMode v)
{
    return sendChecked(s, QByteArray(":TIMebase:MODE ") +
                              ((v == Enum_Scope_TimebaseMode::m_enumXY) ? "XY" : "MAIN"));
}
ScopeError CMSO6054APlugin::setVectors(U32BIT s, bool v)
{
    return sendChecked(s, QByteArray(":DISPlay:VECTors ") + (v ? "ON" : "OFF"));
}

ScopeError CMSO6054APlugin::saveSetup(U32BIT s, U32BIT loc)
{
    return sendChecked(s, QByteArray("*SAV ") + QByteArray::number(loc));
}
ScopeError CMSO6054APlugin::recallSetup(U32BIT s, U32BIT loc)
{
    return sendChecked(s, QByteArray("*RCL ") + QByteArray::number(loc));
}
ScopeError CMSO6054APlugin::saveWaveformToFile(U32BIT s, U32BIT c, const QString& path)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CMSO6054APlugin::saveToReference(U32BIT s, U32BIT c, U32BIT slot)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CMSO6054APlugin::displayReference(U32BIT s, U32BIT slot, bool v)
{
    (void)slot;
    return sendChecked(s, QByteArray(":REFerence:DISPlay ") + (v ? "ON" : "OFF"));
}

ScopeError CMSO6054APlugin::enableDigitalChannel(U32BIT s, U32BIT d, bool v)
{
...
ScopeError CMSO6054APlugin::setDigitalThreshold(U32BIT s, U32BIT d, FDOUBLE v)
{
    if (!m_pLimits->m_bHasDigital)
    {
        return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
...
ScopeError CMSO6054APlugin::setPodThreshold(U32BIT s, U32BIT p, FDOUBLE v)
{
    if (!m_pLimits->m_bHasDigital)
    {
        return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
...
ScopeError CMSO6054APlugin::enableBus(U32BIT s, U32BIT b, bool v)
{
...
ScopeError CMSO6054APlugin::setBusType(U32BIT s, U32BIT b, const QString& v)
{
    if (!m_pLimits->m_bHasSerialDecode)
    {
        return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
...
ScopeError CMSO6054APlugin::readBusDecode(U32BIT s, U32BIT b, QString& o)
{
    if (!m_pLimits->m_bHasSerialDecode)
    {
        return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
...
ScopeError CMSO6054APlugin::setAwgFunction(U32BIT s, const QString& v)
{
...
ScopeError CMSO6054APlugin::setAwgFrequency(U32BIT s, FDOUBLE v)
{
    if (!m_pLimits->m_bHasAWG)
    {
        return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
...
ScopeError CMSO6054APlugin::setAwgAmplitude(U32BIT s, FDOUBLE v)
{
    if (!m_pLimits->m_bHasAWG)
    {
        return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
...
ScopeError CMSO6054APlugin::setAwgOffset(U32BIT s, FDOUBLE v)
{
    if (!m_pLimits->m_bHasAWG)
    {
        return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
...
ScopeError CMSO6054APlugin::enableAwgOutput(U32BIT s, bool v)
{
    if (!m_pLimits->m_bHasAWG)
    {
        return ScopeError(Enum_Scope_ErrorCode::NOT_SUPPORTED);
...
ScopeError CMSO6054APlugin::readOperationStatus(U32BIT s, U32BIT& o)
{
    FDOUBLE d = 0;
...
ScopeError CMSO6054APlugin::readQuestionableStatus(U32BIT s, U32BIT& o)
{
    (void)s;
    o = 0u;
    return ScopeError();
}
ScopeError CMSO6054APlugin::getInstrumentErrorCount(U32BIT s, U32BIT& o)
{
    QByteArray r;
    ScopeError e = queryLine(s, QByteArrayLiteral(":SYSTem:ERRor?"), r);
    if (!e.isSuccess())
...
ScopeError CMSO6054APlugin::setRemoteState(U32BIT s, Enum_Scope_RemoteState v)
{
    (void)v;
    return writeLine(s, QByteArrayLiteral("*OPC"));
}
ScopeError CMSO6054APlugin::getRemoteState(U32BIT s, Enum_Scope_RemoteState& o)
{
    (void)s;
    o = Enum_Scope_RemoteState::m_enumRemote;
    return ScopeError();
}
ScopeError CMSO6054APlugin::setKeyLock(U32BIT s, bool v)
{
    return sendChecked(s, QByteArray(":SYSTem:LOCK ") + (v ? "ON" : "OFF"));
}
ScopeError CMSO6054APlugin::isKeyLocked(U32BIT s, bool& o)
{
    FDOUBLE d = 0;
...
ScopeError CMSO6054APlugin::setBeeper(U32BIT s, bool v)
{
    (void)v;
    return writeLine(s, QByteArrayLiteral("*CLS"));
}
