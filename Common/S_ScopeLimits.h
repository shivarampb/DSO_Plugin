    ...
    static const S_ScopeLimits s_asCatalog[] =
        {
            ...
            {
                "MDO34", "Tektronix", "3 Series MDO", "MDO3",  4,      16,   1.0e9,
            ...
            {"DSOS204A", "Keysight", "Infiniium S-Series",
             "DSOS204A", 4,          0,
             2.0e9,      20.0e9,     100000000u,
             1.0e-3,     5.0,        100.0,
             1.0e-11,    20.0,       0.0,
             10.0,       65536,      false,
             true,       false,      true,
            ...
            {"DSOX2012A", "Keysight", "InfiniiVision 2000 X",
             "DSOX2012A", 2,          0,
             1.0e8,       2.0e9,      100000u,
             1.0e-3,      5.0,        100.0,
             5.0e-9,      50.0,       0.0,
            ...
            {"MSO6054A", "Agilent", "6000 Series MSO",
             "MSO6054A", 4,         16,
             5.0e8,      4.0e9,     8000000u,
             1.0e-3,     5.0,       100.0,
             1.0e-9,     50.0,      0.0,
             10.0,       65536,     false,
             true,       true,      true,
            ...
            {"TDS1012B", "Tektronix", "TDS1000B", "TDS1012B", 2,    0,   1.0e8,    1.0e9,   2500u,
             2.0e-3,     5.0,         50.0,       2.5e-9,     50.0, 0.0, 8.0,      128,     false,
             true,       false,       false,      false,      0.0,  0.0, "0x0699", "0x0367"},

            /* TDS2024C - Tektronix TDS2000C (entry / legacy SCPI) */
            {"TDS2024C", "Tektronix", "TDS2000C", "TDS2024C", 4,    0,   2.0e8,    2.0e9,   2500u,
             2.0e-3,     5.0,         50.0,       1.0e-9,     50.0, 0.0, 8.0,      128,     false,
             true,       false,       false,      false,      0.0,  0.0, "0x0699", "0x03A4"},
