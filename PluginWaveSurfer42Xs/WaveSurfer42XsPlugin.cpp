...
ScopeError CWaveSurfer42XsPlugin::setDouble(U32BIT s, const char* scpi, FDOUBLE v, FDOUBLE lo, FDOUBLE hi, const char* what)
{
...
ScopeError CWaveSurfer42XsPlugin::reset(U32BIT s)       { return sendChecked(s, QByteArrayLiteral("*RST")); }
ScopeError CWaveSurfer42XsPlugin::clearStatus(U32BIT s) { return writeLine(s, QByteArrayLiteral("*CLS")); }
...
ScopeError CWaveSurfer42XsPlugin::waitOperationComplete(U32BIT s) { QByteArray r; return queryLine(s, QByteArrayLiteral("*OPC?"), r); }
...
ScopeError CWaveSurfer42XsPlugin::getParameterRange(U32BIT s, U32BIT c, Enum_Scope_ParamId p, S_Scope_ParameterRange& o)
{
...
ScopeError CWaveSurfer42XsPlugin::autoscale(U32BIT s)    { return sendChecked(s, QByteArrayLiteral(":AUToscale")); }
ScopeError CWaveSurfer42XsPlugin::run(U32BIT s)          { ScopeError e = writeLine(s, QByteArrayLiteral(":RUN")); if (e.isSuccess()) { S_DeviceInstance* d = dev(s); if (d) d->m_bRunning = true; } return e; }
ScopeError CWaveSurfer42XsPlugin::stop(U32BIT s)         { ScopeError e = writeLine(s, QByteArrayLiteral(":STOP")); if (e.isSuccess()) { S_DeviceInstance* d = dev(s); if (d) d->m_bRunning = false; } return e; }
ScopeError CWaveSurfer42XsPlugin::single(U32BIT s)       { ScopeError e = writeLine(s, QByteArrayLiteral(":SINGle")); if (e.isSuccess()) { S_DeviceInstance* d = dev(s); if (d) d->m_bRunning = false; } return e; }
ScopeError CWaveSurfer42XsPlugin::forceTrigger(U32BIT s) { return writeLine(s, QByteArrayLiteral(":TRIGger:FORCe")); }
...
ScopeError CWaveSurfer42XsPlugin::getTimebaseScale(U32BIT s, FDOUBLE& o) { return queryDouble(s, QByteArrayLiteral(":TIMebase:SCALe?"), o); }
ScopeError CWaveSurfer42XsPlugin::setTimebasePosition(U32BIT s, FDOUBLE v) { return sendChecked(s, QByteArray(":TIMebase:POSition ") + fmtD(v)); }
ScopeError CWaveSurfer42XsPlugin::getTimebasePosition(U32BIT s, FDOUBLE& o) { return queryDouble(s, QByteArrayLiteral(":TIMebase:POSition?"), o); }
...
ScopeError CWaveSurfer42XsPlugin::getTriggerHoldoff(U32BIT s, FDOUBLE& o) { return queryDouble(s, QByteArrayLiteral(":TRIGger:HOLDoff?"), o); }
...
ScopeError CWaveSurfer42XsPlugin::clearErrorStatus(U32BIT s, U32BIT) { return writeLine(s, QByteArrayLiteral("*CLS")); }
