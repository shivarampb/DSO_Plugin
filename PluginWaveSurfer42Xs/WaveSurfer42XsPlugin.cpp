/**
 * @file    WaveSurfer42XsPlugin.cpp
 * @brief   Teledyne LeCroy WaveSurfer 42Xs oscilloscope - SCPI-over-VISA plugin implementation.
...
#define KS_MODEL_NAME "WaveSurfer42Xs"

CWaveSurfer42XsPlugin::CWaveSurfer42XsPlugin() : m_pLimits(nullptr), m_strModel(QStringLiteral(KS_MODEL_NAME))
{
...
CWaveSurfer42XsPlugin::~CWaveSurfer42XsPlugin()
{
...
S_Scope_PluginInfo CWaveSurfer42XsPlugin::getPluginInfo() const
{
...
S_Scope_Capabilities CWaveSurfer42XsPlugin::getCapabilities() const
{
...
CWaveSurfer42XsPlugin::S_DeviceInstance* CWaveSurfer42XsPlugin::dev(U32BIT s)
{
    auto it = m_devices.find(s);
    return (it == m_devices.end()) ? nullptr : &it.value();
}
bool CWaveSurfer42XsPlugin::validChannel(U32BIT c) const
{
    return c >= 1 && static_cast<int>(c) <= m_pLimits->m_iAnalogChannels;
}
QByteArray CWaveSurfer42XsPlugin::fmtD(FDOUBLE v)
{
    char sz[40];
    std::snprintf(sz, sizeof(sz), "%.6G", v);
    return QByteArray(sz);
}
int CWaveSurfer42XsPlugin::chanOf(Enum_Scope_TriggerSource e)
{
    switch (e)
    {
...
ScopeError CWaveSurfer42XsPlugin::visaError(ViStatus st, const QString& ctx)
{
    if (st == VI_ERROR_TMO)
    {
 ...
 */
ScopeError CWaveSurfer42XsPlugin::writeLine(U32BIT s, const QByteArray& cmd)
{
 ...
 */
ScopeError CWaveSurfer42XsPlugin::readLine(U32BIT s, QByteArray& resp)
{
    resp.clear();
    S_DeviceInstance* d = dev(s);
    if (d == nullptr || !d->m_bConnected)
 ...
 * @pre    The scope slot must be connected (see connect()).
 */
ScopeError CWaveSurfer42XsPlugin::queryLine(U32BIT s, const QByteArray& cmd, QByteArray& resp)
{
 ...
 */
ScopeError CWaveSurfer42XsPlugin::readBinaryBlock(U32BIT s, QByteArray& payload)
{
    payload.clear();
    S_DeviceInstance* d = dev(s);
    if (d == nullptr || !d->m_bConnected)
 ...
 * @pre    The scope slot must be connected (see connect()).
 */
ScopeError CWaveSurfer42XsPlugin::sendChecked(U32BIT s, const QByteArray& cmd)
{
    ScopeError e = writeLine(s, cmd);
    if (!e.isSuccess())
    {
 ...
 * @pre    The scope slot must be connected (see connect()).
 */
ScopeError CWaveSurfer42XsPlugin::queryDouble(U32BIT s, const QByteArray& cmd, FDOUBLE& o)
{
    QByteArray resp;
 ...
 * @pre    The scope slot must be connected (see connect()).
 */
ScopeError CWaveSurfer42XsPlugin::setDouble(U32BIT s, const char* scpi, FDOUBLE v, FDOUBLE lo, FDOUBLE hi,
                                            const char* what)
{
    if (v < lo || v > hi)
    {
 ...
 */
ScopeError CWaveSurfer42XsPlugin::connect(U32BIT s, const S_Scope_ConnectionConfig& c)
{
...
ScopeError CWaveSurfer42XsPlugin::disconnect(U32BIT s)
{
    S_DeviceInstance* d = dev(s);
    if (d == nullptr)
    {
...
bool CWaveSurfer42XsPlugin::isConnected(U32BIT s) const
{
    auto it = m_devices.find(s);
    return it != m_devices.end() && it.value().m_bConnected;
}
ScopeError CWaveSurfer42XsPlugin::reset(U32BIT s)
{
    return sendChecked(s, QByteArrayLiteral("*RST"));
}
ScopeError CWaveSurfer42XsPlugin::clearStatus(U32BIT s)
{
    return writeLine(s, QByteArrayLiteral("*CLS"));
}
ScopeError CWaveSurfer42XsPlugin::setTimeout(U32BIT s, U32BIT t)
{
    S_DeviceInstance* d = dev(s);
    if (!d)
    {
...
ScopeError CWaveSurfer42XsPlugin::getIdentification(U32BIT s, QString& o)
{
    QByteArray r;
...
ScopeError CWaveSurfer42XsPlugin::selfTest(U32BIT s, S32BIT& o)
{
    FDOUBLE d = 0;
...
ScopeError CWaveSurfer42XsPlugin::getOptions(U32BIT s, QString& o)
{
    QByteArray r;
...
ScopeError CWaveSurfer42XsPlugin::waitOperationComplete(U32BIT s)
{
    QByteArray r;
    return queryLine(s, QByteArrayLiteral("*OPC?"), r);
}
ScopeError CWaveSurfer42XsPlugin::getScpiVersion(U32BIT s, QString& o)
{
    if (!isConnected(s))
    {
        return ScopeError(Enum_Scope_ErrorCode::NOT_CONNECTED);
...
ScopeError CWaveSurfer42XsPlugin::getParameterRange(U32BIT s, U32BIT c, Enum_Scope_ParamId p,
...
ScopeError CWaveSurfer42XsPlugin::autoscale(U32BIT s)
{
    return sendChecked(s, QByteArrayLiteral(":AUToscale"));
}
ScopeError CWaveSurfer42XsPlugin::run(U32BIT s)
{
...
ScopeError CWaveSurfer42XsPlugin::stop(U32BIT s)
{
...
ScopeError CWaveSurfer42XsPlugin::single(U32BIT s)
{
...
ScopeError CWaveSurfer42XsPlugin::forceTrigger(U32BIT s)
{
    return writeLine(s, QByteArrayLiteral(":TRIGger:FORCe"));
}

ScopeError CWaveSurfer42XsPlugin::enableChannel(U32BIT s, U32BIT c, bool v)
{
    if (!validChannel(c))
    {
...
ScopeError CWaveSurfer42XsPlugin::isChannelEnabled(U32BIT s, U32BIT c, bool& o)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::setVerticalScale(U32BIT s, U32BIT c, FDOUBLE v)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::getVerticalScale(U32BIT s, U32BIT c, FDOUBLE& o)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::setVerticalOffset(U32BIT s, U32BIT c, FDOUBLE v)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::getVerticalOffset(U32BIT s, U32BIT c, FDOUBLE& o)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::setCoupling(U32BIT s, U32BIT c, Enum_Scope_Coupling v)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::getCoupling(U32BIT s, U32BIT c, Enum_Scope_Coupling& o)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::setProbeAttenuation(U32BIT s, U32BIT c, FDOUBLE v)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::getProbeAttenuation(U32BIT s, U32BIT c, FDOUBLE& o)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::setTimebaseScale(U32BIT s, FDOUBLE v)
{
    return setDouble(s, ":TIMebase:SCALe", v, m_pLimits->m_dTimebaseMin, m_pLimits->m_dTimebaseMax,
                     "timebase scale");
}
ScopeError CWaveSurfer42XsPlugin::getTimebaseScale(U32BIT s, FDOUBLE& o)
{
    return queryDouble(s, QByteArrayLiteral(":TIMebase:SCALe?"), o);
}
ScopeError CWaveSurfer42XsPlugin::setTimebasePosition(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":TIMebase:POSition ") + fmtD(v));
}
ScopeError CWaveSurfer42XsPlugin::getTimebasePosition(U32BIT s, FDOUBLE& o)
{
    return queryDouble(s, QByteArrayLiteral(":TIMebase:POSition?"), o);
}
ScopeError CWaveSurfer42XsPlugin::getSampleRate(U32BIT s, FDOUBLE& o)
{
    FDOUBLE sr = 0;
...
ScopeError CWaveSurfer42XsPlugin::setMemoryDepth(U32BIT s, U32BIT v)
{
...
ScopeError CWaveSurfer42XsPlugin::getMemoryDepth(U32BIT s, U32BIT& o)
{
    FDOUBLE d = 0;
...
ScopeError CWaveSurfer42XsPlugin::setTriggerMode(U32BIT s, Enum_Scope_TriggerMode v)
{
...
ScopeError CWaveSurfer42XsPlugin::getTriggerMode(U32BIT s, Enum_Scope_TriggerMode& o)
{
    QByteArray r;
...
ScopeError CWaveSurfer42XsPlugin::setTriggerSource(U32BIT s, Enum_Scope_TriggerSource v)
{
...
ScopeError CWaveSurfer42XsPlugin::getTriggerSource(U32BIT s, Enum_Scope_TriggerSource& o)
{
    QByteArray r;
...
ScopeError CWaveSurfer42XsPlugin::setTriggerSlope(U32BIT s, Enum_Scope_TriggerSlope v)
{
...
ScopeError CWaveSurfer42XsPlugin::getTriggerSlope(U32BIT s, Enum_Scope_TriggerSlope& o)
{
    QByteArray r;
...
ScopeError CWaveSurfer42XsPlugin::setTriggerLevel(U32BIT s, U32BIT c, FDOUBLE v)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::getTriggerLevel(U32BIT s, U32BIT c, FDOUBLE& o)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::setTriggerHoldoff(U32BIT s, FDOUBLE v)
{
    return setDouble(s, ":TRIGger:HOLDoff", v, m_pLimits->m_dTrigHoldoffMin, m_pLimits->m_dTrigHoldoffMax,
                     "holdoff");
}
ScopeError CWaveSurfer42XsPlugin::getTriggerHoldoff(U32BIT s, FDOUBLE& o)
{
    return queryDouble(s, QByteArrayLiteral(":TRIGger:HOLDoff?"), o);
}
ScopeError CWaveSurfer42XsPlugin::getTriggerState(U32BIT s, Enum_Scope_TriggerState& o)
{
    QByteArray r;
...
ScopeError CWaveSurfer42XsPlugin::setAcqMode(U32BIT s, Enum_Scope_AcqMode v)
{
...
ScopeError CWaveSurfer42XsPlugin::getAcqMode(U32BIT s, Enum_Scope_AcqMode& o)
{
    QByteArray r;
...
ScopeError CWaveSurfer42XsPlugin::setAverageCount(U32BIT s, U32BIT v)
{
...
ScopeError CWaveSurfer42XsPlugin::getAverageCount(U32BIT s, U32BIT& o)
{
    FDOUBLE d = 0;
...
ScopeError CWaveSurfer42XsPlugin::getAcquisitionState(U32BIT s, Enum_Scope_AcqState& o)
{
    S_DeviceInstance* d = dev(s);
    if (!d || !d->m_bConnected)
    {
...
ScopeError CWaveSurfer42XsPlugin::setWaveformSource(U32BIT s, Enum_Scope_WaveformSource v, U32BIT i)
{
...
ScopeError CWaveSurfer42XsPlugin::setWaveformFormat(U32BIT s, Enum_Scope_WaveformFormat v)
{
...
ScopeError CWaveSurfer42XsPlugin::setWaveformPoints(U32BIT s, U32BIT v)
{
    if (v < 1 || v > m_pLimits->m_u32MaxMemoryDepth)
    {
        return ScopeError(Enum_Scope_ErrorCode::PARAMETER_OUT_OF_RANGE,
...
ScopeError CWaveSurfer42XsPlugin::getWaveformPreamble(U32BIT s, U32BIT c, S_Scope_WaveformPreamble& o)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
 ...
 */
ScopeError CWaveSurfer42XsPlugin::readWaveform(U32BIT s, U32BIT c, S_Scope_Waveform& o)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::digitizeChannel(U32BIT s, U32BIT c)
{
    if (!validChannel(c))
    {
        return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
...
ScopeError CWaveSurfer42XsPlugin::captureScreenshot(U32BIT s, Enum_Scope_ImageFormat f, QByteArray& o)
{
...
ScopeError CWaveSurfer42XsPlugin::readErrorStatus(U32BIT s, U32BIT, S_Scope_DeviceErrorStatus& o)
{
...
ScopeError CWaveSurfer42XsPlugin::clearErrorStatus(U32BIT s, U32BIT)
{
    return writeLine(s, QByteArrayLiteral("*CLS"));
}
ScopeError CWaveSurfer42XsPlugin::queryErrorQueue(U32BIT s, QString& o)
{
    QByteArray r;
...
ScopeError CWaveSurfer42XsPlugin::readStatusByte(U32BIT s, U32BIT& o)
{
    FDOUBLE d = 0;
...
ScopeError CWaveSurfer42XsPlugin::readStandardEventStatus(U32BIT s, U32BIT& o)
{
    FDOUBLE d = 0;
...
ScopeError CWaveSurfer42XsPlugin::writeScpi(U32BIT s, const QString& v)
{
...
ScopeError CWaveSurfer42XsPlugin::readMeasurement(U32BIT s, U32BIT c, Enum_Scope_MeasType t,
...
ScopeError CWaveSurfer42XsPlugin::clearMeasurements(U32BIT s)
{
...
ScopeError CWaveSurfer42XsPlugin::getMeasurementStatistics(U32BIT s, U32BIT c, Enum_Scope_MeasType t,
                                                           S_Scope_MeasurementResult& o)
{
...
ScopeError CWaveSurfer42XsPlugin::readCursorValues(U32BIT s, FDOUBLE& x1, FDOUBLE& x2, FDOUBLE& y1,
                                                   FDOUBLE& y2)
{
...
ScopeError CWaveSurfer42XsPlugin::enableMath(U32BIT s, bool v)
{
...
ScopeError CWaveSurfer42XsPlugin::setFftSpan(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":FUNCtion:FFT:SPAN ") + fmtD(v));
}
ScopeError CWaveSurfer42XsPlugin::setFftCenter(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":FUNCtion:FFT:CENTer ") + fmtD(v));
}
ScopeError CWaveSurfer42XsPlugin::setMathScale(U32BIT s, FDOUBLE v)
{
    return sendChecked(s, QByteArray(":FUNCtion:SCALe ") + fmtD(v));
}
ScopeError CWaveSurfer42XsPlugin::setMathPosition(U32BIT s, FDOUBLE v)
{
...
ScopeError CWaveSurfer42XsPlugin::setGraticule(U32BIT s, const QString& v)
{
    return sendChecked(s, QByteArray(":DISPlay:GRATicule ") + v.toLatin1());
}
ScopeError CWaveSurfer42XsPlugin::setIntensity(U32BIT s, FDOUBLE v)
{
...
ScopeError CWaveSurfer42XsPlugin::setVectors(U32BIT s, bool v)
{
    return sendChecked(s, QByteArray(":DISPlay:VECTors ") + (v ? "ON" : "OFF"));
}

ScopeError CWaveSurfer42XsPlugin::saveSetup(U32BIT s, U32BIT loc)
{
    return sendChecked(s, QByteArray("*SAV ") + QByteArray::number(loc));
}
ScopeError CWaveSurfer42XsPlugin::recallSetup(U32BIT s, U32BIT loc)
{
...
ScopeError CWaveSurfer42XsPlugin::setKeyLock(U32BIT s, bool v)
{
...
ScopeError CWaveSurfer42XsPlugin::setBeeper(U32BIT s, bool v)
{
    (void)v;
    return writeLine(s, QByteArrayLiteral("*CLS"));
}
