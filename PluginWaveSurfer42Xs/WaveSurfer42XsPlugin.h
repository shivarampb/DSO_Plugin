/**
 * @file    WaveSurfer42XsPlugin.h
 * @brief   Teledyne LeCroy WaveSurfer 42Xs oscilloscope - self-contained CIScopePlugin plugin.
 * @author  Scope framework
 * @date    2026
 * @note    MISRA C++:2023-aligned; Allman braces; see docs/Coding_Standard.md.
 */

#ifndef WaveSurfer42XsPLUGIN_H
#define WaveSurfer42XsPLUGIN_H
...
class CWaveSurfer42XsPlugin : public QObject, public CIScopePlugin
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID ScopePlugin_iid)
    Q_INTERFACES(CIScopePlugin)
  public:
    CWaveSurfer42XsPlugin();
    ~CWaveSurfer42XsPlugin() override;
