/*============================================================================
 *  DSOS204APlugin.cpp - Keysight InfiniiVision 2000 X-Series plugin.
 ...
 *  MockVisa emulator; TODO(manual) constants await manuals/DSOS204A/.
 *==========================================================================*/
...
ScopeError CDSOS204APlugin::setDouble(U32BIT s, const char* scpi, FDOUBLE v, FDOUBLE lo, FDOUBLE hi, const char* what)
{
...
ScopeError CDSOS204APlugin::reset(U32BIT s)       { return sendChecked(s, QByteArrayLiteral("*RST")); }
ScopeError CDSOS204APlugin::clearStatus(U32BIT s) { return writeLine(s, QByteArrayLiteral("*CLS")); }
...
ScopeError CDSOS204APlugin::waitOperationComplete(U32BIT s) { QByteArray r; return queryLine(s, QByteArrayLiteral("*OPC?"), r); }
...
ScopeError CDSOS204APlugin::getParameterRange(U32BIT s, U32BIT c, Enum_Scope_ParamId p, S_Scope_ParameterRange& o)
{
...
ScopeError CDSOS204APlugin::autoscale(U32BIT s)    { return sendChecked(s, QByteArrayLiteral(":AUToscale")); }
ScopeError CDSOS204APlugin::run(U32BIT s)          { ScopeError e = writeLine(s, QByteArrayLiteral(":RUN")); if (e.isSuccess()) { S_DeviceInstance* d = dev(s); if (d) d->m_bRunning = true; } return e; }
ScopeError CDSOS204APlugin::stop(U32BIT s)         { ScopeError e = writeLine(s, QByteArrayLiteral(":STOP")); if (e.isSuccess()) { S_DeviceInstance* d = dev(s); if (d) d->m_bRunning = false; } return e; }
ScopeError CDSOS204APlugin::single(U32BIT s)       { ScopeError e = writeLine(s, QByteArrayLiteral(":SINGle")); if (e.isSuccess()) { S_DeviceInstance* d = dev(s); if (d) d->m_bRunning = false; } return e; }
ScopeError CDSOS204APlugin::forceTrigger(U32BIT s) { return writeLine(s, QByteArrayLiteral(":TRIGger:FORCe")); }
...
ScopeError CDSOS204APlugin::getTimebaseScale(U32BIT s, FDOUBLE& o) { return queryDouble(s, QByteArrayLiteral(":TIMebase:SCALe?"), o); }
ScopeError CDSOS204APlugin::setTimebasePosition(U32BIT s, FDOUBLE v) { return sendChecked(s, QByteArray(":TIMebase:POSition ") + fmtD(v)); }
ScopeError CDSOS204APlugin::getTimebasePosition(U32BIT s, FDOUBLE& o) { return queryDouble(s, QByteArrayLiteral(":TIMebase:POSition?"), o); }
...
ScopeError CDSOS204APlugin::getTriggerHoldoff(U32BIT s, FDOUBLE& o) { return queryDouble(s, QByteArrayLiteral(":TRIGger:HOLDoff?"), o); }
...
ScopeError CDSOS204APlugin::clearErrorStatus(U32BIT s, U32BIT) { return writeLine(s, QByteArrayLiteral("*CLS")); }
...
ScopeError CDSOS204APlugin::writeScpi(U32BIT s, const QString& v) { return writeLine(s, v.toLatin1()); }
...
ScopeError CDSOS204APlugin::readMeasurement(U32BIT s, U32BIT c, Enum_Scope_MeasType t, S_Scope_MeasurementResult& o)
{
    if (!validChannel(c)) return ScopeError(Enum_Scope_ErrorCode::INVALID_CHANNEL);
    FDOUBLE v = 0.0;
...
ScopeError CDSOS204APlugin::clearMeasurements(U32BIT s) { return writeLine(s, QByteArrayLiteral(":MEASure:CLEar")); }
...
ScopeError CDSOS204APlugin::getMeasurementStatistics(U32BIT s, U32BIT c, Enum_Scope_MeasType t, S_Scope_MeasurementResult& o)
...
ScopeError CDSOS204APlugin::enableMath(U32BIT s, bool v) { return sendChecked(s, QByteArray(":FUNCtion:DISPlay ") + (v ? "ON" : "OFF")); }
...
ScopeError CDSOS204APlugin::setFftSpan(U32BIT s, FDOUBLE v)   { return sendChecked(s, QByteArray(":FUNCtion:FFT:SPAN ") + fmtD(v)); }
ScopeError CDSOS204APlugin::setFftCenter(U32BIT s, FDOUBLE v) { return sendChecked(s, QByteArray(":FUNCtion:FFT:CENTer ") + fmtD(v)); }
ScopeError CDSOS204APlugin::setMathScale(U32BIT s, FDOUBLE v)    { return sendChecked(s, QByteArray(":FUNCtion:SCALe ") + fmtD(v)); }
ScopeError CDSOS204APlugin::setMathPosition(U32BIT s, FDOUBLE v) { return sendChecked(s, QByteArray(":FUNCtion:OFFSet ") + fmtD(v)); }
...
ScopeError CDSOS204APlugin::setGraticule(U32BIT s, const QString& v) { return sendChecked(s, QByteArray(":DISPlay:GRATicule ") + v.toLatin1()); }
ScopeError CDSOS204APlugin::setIntensity(U32BIT s, FDOUBLE v) { return sendChecked(s, QByteArray(":DISPlay:INTensity:WAVeform ") + fmtD(v)); }
...
ScopeError CDSOS204APlugin::setVectors(U32BIT s, bool v) { return sendChecked(s, QByteArray(":DISPlay:VECTors ") + (v ? "ON" : "OFF")); }

ScopeError CDSOS204APlugin::saveSetup(U32BIT s, U32BIT loc)  { return sendChecked(s, QByteArray("*SAV ") + QByteArray::number(loc)); }
ScopeError CDSOS204APlugin::recallSetup(U32BIT s, U32BIT loc){ return sendChecked(s, QByteArray("*RCL ") + QByteArray::number(loc)); }
...
ScopeError CDSOS204APlugin::setKeyLock(U32BIT s, bool v) { return sendChecked(s, QByteArray(":SYSTem:LOCK ") + (v ? "ON" : "OFF")); }
...
ScopeError CDSOS204APlugin::setBeeper(U32BIT s, bool v) { (void)v; return writeLine(s, QByteArrayLiteral("*CLS")); }
